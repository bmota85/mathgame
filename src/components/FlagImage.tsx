...
export const FlagImage: React.FC<Props> = ({ flagId, size = 'md', selected = false, onClick }) => {
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: selected ? '0 0 0 6px rgba(108,99,255,0.25), 0 6px 20px rgba(0,0,0,0.2)' : '0 4px 16px rgba(0,0,0,0.15)',
